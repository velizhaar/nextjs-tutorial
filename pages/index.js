    ...
    <>
      ...
      <div>
        ...
        <p className={styles.text}>
          ...
          consectetur eveniet voluptas eaque maxime reprehenderit porro
          mollitia, consequatur quia quibusdam modi accusamus. Laboriosam,
          ratione ex odio quibusdam optio sed id.
        </p>
        <p className={styles.text}>
